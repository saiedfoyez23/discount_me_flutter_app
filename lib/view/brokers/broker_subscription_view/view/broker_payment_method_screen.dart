...
class BrokerPaymentMethodScreen extends StatefulWidget {
  ...
  @override
  State<BrokerPaymentMethodScreen> createState() => _BrokerPaymentMethodScreenState();
}

class _BrokerPaymentMethodScreenState extends State<BrokerPaymentMethodScreen> {
              ...
              Padding(
                ...
                child: Roundbutton(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => BrokerCardInformationScreen()),
                    );
                  },
                ),
              ),
