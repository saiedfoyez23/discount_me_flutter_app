...
class BrokerCardInformationScreen extends StatefulWidget {
  ...
  @override
  State<BrokerCardInformationScreen> createState() => _BrokerCardInformationScreenState();
}

class _BrokerCardInformationScreenState extends State<BrokerCardInformationScreen> {
          ...
          child: SizedBox(
            ...
            child: Roundbutton(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => BrokerTransactionSuccessScreen()),
                );
              },
            ),
          ),
